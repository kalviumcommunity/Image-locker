...
function Update() {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .patch(
        `https://squad51-image-locker.onrender.com/updateuser/${formData.id}`,
        {
          name: formData.name,
  ...
  return (
    <div style={updateContainerStyle}>
      ...
      <form style={formStyle} onSubmit={handleSubmit}>
        ...
        <label style={labelStyle}>
          Links:
          <input type="text" name="imageLinks" value={formData.imageLinks} onChange={handleChange} style={inputStyle} />
        </label>
        <label style={labelStyle}>
          Created By:
